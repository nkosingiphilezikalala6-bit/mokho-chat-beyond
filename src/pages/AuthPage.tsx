  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <span className="text-4xl font-extrabold text-destructive tracking-tight">MOKHO</span>
      </div>
      ...
      <div className="w-full max-w-sm">
        <div className="bg-card rounded-2xl border border-border p-6 shadow-lg">
          ...
          <p className="text-sm text-muted-foreground text-center mb-6">
            {isLogin ? "Sign in to continue to MOKHO" : "Join MOKHO today — it's free!"}
          </p>
          ...
          <form onSubmit={handleEmailAuth} className="space-y-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                minLength={6}
                className="w-full pl-10 pr-10 py-2.5 rounded-xl bg-secondary text-foreground text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-destructive/30"
              />
              <button
                type="button"
          ...
          {isLogin && (
            <button className="w-full text-center text-xs text-destructive mt-3 hover:underline">
              Forgot password?
            </button>
          )}
        </div>
